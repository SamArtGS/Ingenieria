...
class Biblioteca: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    let DescripEscul:[String] = ["Frente a la biblioteca Enrique Rivero Borrrel, ubicada en el anexo de la Facultad de Ingenierla. Su nombre es LA LEONARDITA en honor a Leonardo Oa Vinci esta es una obra de gran formato, hecha de metal en la cual el artista Ie imprime: emocion, ideas y sentimientos."]
