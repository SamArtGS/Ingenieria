...
class PDFDirecto: UIViewController,UIWebViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        if GlobalVariable.myString == 0 || GlobalVariable.myString == 2 || GlobalVariable.myString == 4 || GlobalVariable.myString == 19 {
